...
final class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversNoItemsOn200HTTPResponseWithyEmptyJSON()  {
        let (sut, client) = makeSUT()
    ...
    func test_load_deliversItemsOn200HTTPResponseWithValidJSON()  {
        ...
        let imems = [item1.model, item2.model]
        expect(sut, toCompleteWith: .success(imems)) {
    ...
    private func makeSUT(url: URL = URL(string: "https://a-url.com")!,file: StaticString = #filePath,
                         line: UInt = #line) -> (sut: RemoteFeedLoader, client: HTTPClintSpy) {
        let client = HTTPClintSpy()
    ...
    private func expect(_ sut: RemoteFeedLoader, toCompleteWith expectedResult: RemoteFeedLoader.Result, when action: () -> Void, file: StaticString = #filePath,
                        line: UInt = #line) {
